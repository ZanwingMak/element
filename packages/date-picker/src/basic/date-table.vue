...
// import sw from "../../../../src/locale/lang/sw";
...
export default {
        ...
        for (let j = 0; j < 7; j++) {
          ...
          if (this.tableType) {
            if (this.tableType === 'min') {
              ...
              cell.inRange = time <= getDateTimestamp(this.maxDate);
  ...
  methods: {
    ...
    markRange(minDate, maxDate) {
      minDate = getDateTimestamp(minDate instanceof Object ? String(minDate) : minDate);
      maxDate = getDateTimestamp(maxDate instanceof Object ? String(maxDate) : maxDate) || this.value && this.value.length === 2 && this.value[1];
      if (!this.tableType) {
